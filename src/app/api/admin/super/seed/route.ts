...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("🚀 Starting database seeding via Super Admin Console...");
    ...
    return NextResponse.json({
      success: true,
      message: "База данных успешно заполнена демо-данными (SubscriptionPlans, Templates, 6 Demo Businesses, Items, Categories, Staff, Bookings, Orders)."
    });
  } catch (error: any) {
