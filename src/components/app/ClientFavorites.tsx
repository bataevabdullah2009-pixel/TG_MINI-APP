                ...
                data.favoriteItems.map((fav) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-1 whitespace-nowrap text-[11px] font-black text-indigo-600">
                        {typeof fav.item?.price === "number" ? `${fav.item.price} ₽` : "Цена уточняется"}
                      </p>
                      <span className="mt-1 block truncate text-[9px] font-semibold text-slate-400">Магазин: {fav.business?.name || fav.businessId || "не указан"}</span>
                    </div>
