...
export class PolzaAIProvider implements AIProvider {
  ...
  async generateFAQAnswer(input: any): Promise<string> {
    const system = [
      ...
      "Отвечай коротко, по делу, на русском языке и только на основе базы знаний текущего бизнеса.",
      "Не используй данные другого бизнеса. Не выдумывай адреса, товары, услуги, цены и условия.",
